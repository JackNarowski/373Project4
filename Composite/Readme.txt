...
This code is a basic implementation of the Composite pattern.

My pattern is designed to tract the time it takes an operation to occur.
...
Main is the client
Component is the interface for all the objects
Composite is a combination of the Components
Step is a leaf